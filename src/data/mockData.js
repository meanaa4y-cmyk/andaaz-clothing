...
export const initialProducts = [
  ...
  { id: 43, name: "Sage Digital-Print Stole", category: "Women", price: 48.00, originalPrice: null, isSale: false, stock: 22, scheduleStatus: "Active", img: "/products/wrap-digital-stole-sage.jpg", desc: "Lightweight sage stole in a modern digital print, a versatile finishing layer." },
  { id: 44, name: "Ochre Embellished Wrap", category: "Women", price: 58.00, originalPrice: 70.00, isSale: true, stock: 16, scheduleStatus: "Active", img: "/products/wrap-embellished-ochre.jpg", desc: "Warm ochre wrap finished with delicate embellished trim along both edges." },
  { id: 45, name: "Gold Trellis Embroidered Dupatta", category: "Women", price: 72.00, originalPrice: null, isSale: false, stock: 14, scheduleStatus: "Active", img: "/products/wrap-embroidered-gold-trellis.jpg", desc: "Fine trellis embroidery in gold thread elevates this classic occasion dupatta." },
  { id: 46, name: "Midnight Net Dupatta", category: "Women", price: 55.00, originalPrice: null, isSale: false, stock: 18, scheduleStatus: "Active", img: "/products/wrap-net-dupatta-midnight.jpg", desc: "Sheer midnight net dupatta with a delicate scalloped border, made for eveningwear." },
  { id: 47, name: "Ivory Printed Chiffon Scarf", category: "Women", price: 42.00, originalPrice: null, isSale: false, stock: 25, scheduleStatus: "Active", img: "/products/wrap-printed-chiffon-ivory.jpg", desc: "Airy ivory chiffon scarf in a soft printed pattern, light enough for year-round wear." },
  { id: 48, name: "Slate Printed Silk Scarf", category: "Women", price: 60.00, originalPrice: 75.00, isSale: true, stock: 13, scheduleStatus: "Active", img: "/products/wrap-printed-silk-slate.jpg", desc: "Slate-toned silk scarf finished in a refined printed motif, a versatile wardrobe layer." },
  { id: 49, name: "Blush Silk Stole", category: "Women", price: 52.00, originalPrice: null, isSale: false, stock: 20, scheduleStatus: "Active", img: "/products/wrap-silk-stole-blush.jpg", desc: "Pure blush silk stole with a soft drape, an elegant layer for any occasion." },
  { id: 50, name: "Dusty Rose Woven Shawl", category: "Women", price: 68.00, originalPrice: null, isSale: false, stock: 15, scheduleStatus: "Active", img: "/products/wrap-woven-shawl-dusty-rose.jpg", desc: "Dusty rose woven shawl with a soft, textured finish, cozy enough for cooler evenings." }
];
